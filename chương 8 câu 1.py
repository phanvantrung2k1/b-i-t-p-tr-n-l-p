...
txtDisplay = Entry(cal, width=30, font=('arial', 20 , 'bold'),textvariable = text_Input,bd=30,insertwidth=4,bg='white',justify='right').grid(columnspan=4)
...
btClear=Button(cal, padx=30, bd=8, fg="black", font=('arial', 20 , 'bold'),text="C", command = btnClean, bg="silver").grid(row=4,column=0)
